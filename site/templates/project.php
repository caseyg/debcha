<?php snippet('header') ?>
<div class="container-fluid project__banner" style="background-color: <?= $page->color() ?>; background-image: <?php if($page->banner()->isNotEmpty()): ?>url('<?php echo $page->banner()->toFile()->url(); ?>')<?php else: ?>url('/assets/banner-texture.jpg') <?php endif; ?>;">
  <?php snippet('nav') ?>
